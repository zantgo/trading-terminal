...
v7.1 (Corrección de Arquitectura):
- Se elimina la definición duplicada de la entidad `Operacion`, que ahora
  reside únicamente en `om/_entities.py` como su única fuente de verdad.
  Esto resuelve conflictos de importación y dependencias circulares.
"""
import datetime
...
class LogicalBalances:
    ...
    def reset(self):
        """Resetea los balances a su estado inicial."""
        self.operational_margin = 0.0
        self.used_margin = 0.0
        self.profit_balance = 0.0

# --- INICIO DE LA SECCIÓN A ELIMINAR (COMENTADA) ---
# La siguiente definición de 'Operacion' es duplicada y causa el error de importación.
# Debe ser eliminada de este archivo. Su única fuente de verdad está en 'om/_entities.py'.
